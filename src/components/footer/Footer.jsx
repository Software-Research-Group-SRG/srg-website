    ...
    return (
        <footer className="relative z-20 mt-auto w-full flex flex-col items-center">
            ...
            >
                ...
                <span className="mt-4 text-[10px] tracking-[0.3em] font-semibold transition-colors"
                      style={{ fontFamily: 'var(--font-family)' }}>
                    SCROLL UP
                </span>
            </button>

            {/* --- The Thin Blue Divider Line --- */}
            ...
            <div className="w-full flex flex-col md:flex-row justify-between items-center py-5 px-6 md:px-12 bg-black/40 backdrop-blur-sm">
                ...
                <div className="flex-1 text-center order-2 md:order-1">
                    <p className="text-[11px] tracking-[0.2em] font-medium"
                       style={{ fontFamily: 'var(--font-family)' }}>
                ...
                <div className="flex-1 flex justify-center md:justify-end items-center gap-4 order-1 md:order-2 mb-4 md:mb-0">
                    <div className="flex items-center text-[12px] tracking-widest" 
                        style={{ color: 'var(--text-title)', 
                            fontFamily: 'var(--font-family-title)'
                        }}>
                        <span className="opacity-90 select-none hidden lg:inline">----------------- // </span>
                        <span className="ml-2 "style={{ color: 'var(--text-title)' }}>004 - GET IN TOUCH</span>
                    </div>
